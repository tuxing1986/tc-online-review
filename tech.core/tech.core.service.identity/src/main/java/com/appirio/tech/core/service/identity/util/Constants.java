...
public class Constants {
    ...
    */
	...
	public static final String MSG_TEMPLATE_INVALID_HANDLE_CONTAINS_SPACE = "The handle may not contain a space";
	
	public static final String MSG_TEMPLATE_INVALID_HANDLE_CONTAINS_FORBIDDEN_CHARS = "The handle may contain only letters, numbers and " + HANDLE_PUNCTUATION;

	public static final String MSG_TEMPLATE_INVALID_HANDLE_CONTAINS_ONLY_PUNCTUATION = "The handle may not contain only punctuation.";
	...
	public static final String MSG_TEMPLATE_INVALID_EMAIL = "Email address is invalid";

	public static final String MSG_TEMPLATE_DUPLICATED_EMAIL = "Email '%s' has already been registered, please use another one.";

	public static final String MSG_TEMPLATE_INVALID_PASSWORD = "Password is too week";
